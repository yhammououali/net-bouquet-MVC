...
echo "<tr>";
    ...
    echo "<th colspan='2'>Administration du produit</th>";
echo "</tr>";
...
foreach($lesProduits as $unProduit)
    ...
    echo "<tr>";
        ...
        echo "<td class='td'><a href='index.php?uc=gererProduit&action=supprimerProduit&id=$id&nom=$nom'>Supprimer</a></td>";
        echo "<td class='td'><a href='index.php?uc=gererProduit&action=modifierProduit&id=$id&nom=$nom'>Modifier</a></td>";
    echo "</tr>";
    }
echo "</table>";
?>
